...
Desktop (≥ 769px):
  ...
  │  • Footer: avatar / nome / tema / logout │
  ├──────────────────────────────────────────┤
...
L'`HeaderComponent` è nascosto su desktop (`display:none`); l'informazione utente (nome, admin badge, tema, logout) vive nel footer della sidebar.
